...
export const BLOG_POSTS = [
  { 
    id:1, emoji:'💻', tag:'Review', 
    title:'MacBook Pro M3 sau 3 tháng sử dụng: Đáng mua không?', 
    ...
    content:'MacBook Pro M3 đã trở thành một phần không thể thiếu trong công việc hàng ngày của tôi. Sau 3 tháng sử dụng, tôi nhận thấy rằng đây là một chiếc laptop tuyệt vời cho những ai cần hiệu năng cao và sự ổn định.\n\n**Hiệu năng**\nChip M3 cung cấp hiệu năng tuyệt vời cho các tác vụ hàng ngày. Từ chỉnh sửa video, xử lý ảnh đến các công việc lập trình, tất cả đều chạy mượt mà. Không có bất kỳ độ trễ nào đáng chú ý.\n\n**Thời lượng pin**\nThời lượng pin có thể lên tới 18 giờ với mức sử dụng bình thường. Điều này rất tuyệt vời cho những ai thường di chuyển nhiều.\n\n**Khía cạnh tiêu cực**\nGiá thành khá cao, không phải ai cũng có khả năng mua. Ngoài ra, cổng kết nối hạn chế, bạn sẽ cần mua hub bổ sung.\n\n**Kết luận**\nMacBook Pro M3 là một chiếc laptop tuyệt vời nếu bạn có ngân sách. Nó cung cấp hiệu năng, sự ổn định và thời lượng pin tuyệt vời. Tôi sẽ khuyến nghị nó cho bất kỳ ai cần một chiếc laptop mạnh mẽ cho công việc chuyên nghiệp.',
    date:'15/01/2024', readTime:'5 phút', views:'12.4K', author:'Minh Tú' 
  },
  { 
    id:2, emoji:'🎮', tag:'Gaming', 
  ...
  { 
    ...
    content:'Nếu bạn là người mới bắt đầu với bàn phím cơ, hãy xem bài viết này để chọn bàn phím phù hợp nhất.\n\n**Keychron**\nKeychron nổi tiếng với thiết kế mỏng, nhẹ và độ bền cao. Giá cả hợp lý, khoảng 1.5-3 triệu VND. Phù hợp cho người mới vì dễ chuyển switch.\n\n**Royal Kludge**\nRoyal Kludge có hình thức đẹp mắt, nhiều tùy chọn. Giá cả từ 1-3 triệu VND. Có wireless option rất tiện.\n\n**So sánh**\n- Giá: Cả hai đều rẻ, có thể chọn tùy theo tính năng\n- Chất lượng: Keychron ổn định hơn, Royal Kludge thời trang hơn\n- Hỗ trợ: Cả hai đều có cộng đồng mạnh mẽ\n\n**Khuyến nghị**\nNếu bạn chỉ muốn bàn phím đơn giản, chọn Keychron. Nếu bạn muốn cái gì đó đẹp hơn và có tính năng wireless, chọn Royal Kludge.',
    date:'08/01/2024', readTime:'4 phút', views:'7.2K', author:'Văn Long' 
  },
  { 
    id:5, emoji:'💾', tag:'Storage', 
    title:'PCIe Gen 4 SSD: Có thực sự nhanh hơn Gen 3 trong thực tế?', 
    excerpt:'Thử nghiệm thực tế tốc độ PCIe Gen 4 SSD so với Gen 3 trong các tác vụ hàng ngày và gaming.',
    ...
    date:'05/01/2024', readTime:'7 phút', views:'5.6K', author:'Bảo Trung' 
  },
  { 
    id:6, emoji:'🖥️', tag:'Monitor', 
